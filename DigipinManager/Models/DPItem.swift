...
enum DPItemSchemaV2: VersionedSchema {
    ...
    class DPItem: Identifiable, Codable {
        ...
        // Codable implementation
        enum CodingKeys: String, CodingKey {
            case id, note, address, latitude, longitude, deleted, favourite, createdAt, updatedAt
        }
...
typealias DPItem = DPItemSchemaV2.DPItem
